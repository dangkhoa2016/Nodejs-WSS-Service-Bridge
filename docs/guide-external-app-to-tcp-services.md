...
> Redis) that runs on another machine behind the Nodejs-WSS-Service-Bridge server.
...
- **Server** (`Nodejs-WSS-Service-Bridge`) — relays streams between the client and
...
| Server | Relay hub (`Nodejs-WSS-Service-Bridge`) | Public host |
